...
import prewed1_1 from "../../assets/images/prewed1_1.jpg";
import prewed1_2 from "../../assets/images/prewed1_2.jpg";
import prewed1_3 from "../../assets/images/prewed1_3.jpg";
import FloatToTop from "../atoms/FloatToTop";
import { StaticImport } from "next/dist/shared/lib/get-img-props";

const Album = () => {
    const renderImage = (url: StaticImport, className?: string) => {
        return <Image src={url} alt='' className={className} />
    }
