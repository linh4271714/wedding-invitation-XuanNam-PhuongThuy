    ...
    return <>
        ...
        <FadingAnimation className="m-auto">
            <div className="flex flex-col w-[400px] 2xl:w-full m-auto gap-0 text-4xl 2xl:text-5xl font-bold px-20 lg:px-10 py-6" style={{ fontFamily: "var(--font-great-vibes)" }}>
                <span className="text-primary self-start h-12 2xl:h-[60px] leading-[48px] 2xl:leading-[64px] text-reading-left-to-right w-full">
                ...
                <span className="text-primary h-12 2xl:h-[60px] leading-[48px] 2xl:leading-[64px] text-reading-left-to-right w-full text-end">
                    <span className="text-secondary">P</span>hương Thuỳ
                </span>
            </div>
        </FadingAnimation>
        <FloatToTop className="px-3">
            <Image
            src={prewed1}
            alt=""
            aria-hidden="true"
